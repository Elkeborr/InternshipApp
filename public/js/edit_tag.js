...
$(function () {
  ...
  $tagArray = [];
  var listItems = Array.from(document.querySelectorAll('a.tag-remove')); // Put all text from .tag-remove into the array
  ...
  $('.tag-list').on('click', "a.tag-remove", function (e) {
    ...
    var tagListItem = $(this).parent(); // Get text of item you want to remove
...
/***/ 4:
/*!****************************************!*\
  !*** multi ./resources/js/edit_tag.js ***!
  \****************************************/
/*! no static exports found */
